...
macro_bpp_prompt_spymaster = '''When faced with a task, begin by identifying the brain regions that will contribute to solving the task. Then, initiate a multi-round collaboration process until a final solution is reached. The brain regions will give critical comments and detailed suggestions whenever necessary. 
...
micro_bpp_prompt_spymaster = '''When faced with a task, begin by identifying the brain regions that will contribute to solving the task. Then, initiate a multi-round collaboration process until a final solution is reached. The brain regions will give critical comments and detailed suggestions whenever necessary. 
...
bpp_prompt_spymaster = '''When faced with a task, begin by identifying the brain regions that will contribute to solving the task. Depending on the complexity of the task, decide whether to assign broad categories of brain regions or divide them into more detailed subcategories. Then, initiate a multi-round collaboration process until a final solution is reached. The brain regions will give critical comments and detailed suggestions whenever necessary.
...
bpp_prompt_w_r_demo_spymaster = '''When faced with a task, begin by identifying the brain regions that will contribute to solving the task. Depending on the complexity of the task, decide whether to assign broad categories of brain regions or divide them into more detailed subcategories. Then, initiate a multi-round collaboration process until a final solution is reached. The brain regions will give critical comments and detailed suggestions whenever necessary.
...
bpp_prompt_w_k_demo_spymaster = '''When faced with a task, begin by identifying the brain regions that will contribute to solving the task. Depending on the complexity of the task, decide whether to assign broad categories of brain regions or divide them into more detailed subcategories. Then, initiate a multi-round collaboration process until a final solution is reached. The brain regions will give critical comments and detailed suggestions whenever necessary.
...
bpp_prompt_two_k_demo_spymaster = '''When faced with a task, begin by identifying the brain regions that will contribute to solving the task. Depending on the complexity of the task, decide whether to assign broad categories of brain regions or divide them into more detailed subcategories. Then, initiate a multi-round collaboration process until a final solution is reached. The brain regions will give critical comments and detailed suggestions whenever necessary.
...
macro_bpp_prompt_guesser = '''When faced with a task, begin by identifying the brain regions that will contribute to solving the task. Then, initiate a multi-round collaboration process until a final solution is reached. The brain regions will give critical comments and detailed suggestions whenever necessary. 
...
meso_bpp_prompt_guesser = '''When faced with a task, begin by identifying the brain regions that will contribute to solving the task. Then, initiate a multi-round collaboration process until a final solution is reached. The brain regions will give critical comments and detailed suggestions whenever necessary. 
...
micro_bpp_prompt_guesser = '''When faced with a task, begin by identifying the brain regions that will contribute to solving the task. Then, initiate a multi-round collaboration process until a final solution is reached. The brain regions will give critical comments and detailed suggestions whenever necessary. 
...
bpp_prompt_guesser = '''When faced with a task, begin by identifying the brain regions that will contribute to solving the task. Depending on the complexity of the task, decide whether to assign broad categories of brain regions or divide them into more detailed subcategories. Then, initiate a multi-round collaboration process until a final solution is reached. The brain regions will give critical comments and detailed suggestions whenever necessary.
...
bpp_prompt_w_r_demo_guesser = '''When faced with a task, begin by identifying the brain regions that will contribute to solving the task. Depending on the complexity of the task, decide whether to assign broad categories of brain regions or divide them into more detailed subcategories. Then, initiate a multi-round collaboration process until a final solution is reached. The brain regions will give critical comments and detailed suggestions whenever necessary.
...
bpp_prompt_w_k_demo_guesser = '''When faced with a task, begin by identifying the brain regions that will contribute to solving the task. Depending on the complexity of the task, decide whether to assign broad categories of brain regions or divide them into more detailed subcategories. Then, initiate a multi-round collaboration process until a final solution is reached. The brain regions will give critical comments and detailed suggestions whenever necessary.
...
bpp_prompt_two_r_demo_guesser = '''When faced with a task, begin by identifying the brain regions that will contribute to solving the task. Depending on the complexity of the task, decide whether to assign broad categories of brain regions or divide them into more detailed subcategories. Then, initiate a multi-round collaboration process until a final solution is reached. The brain regions will give critical comments and detailed suggestions whenever necessary.
...
bpp_prompt_two_k_demo_guesser = '''When faced with a task, begin by identifying the brain regions that will contribute to solving the task. Depending on the complexity of the task, decide whether to assign broad categories of brain regions or divide them into more detailed subcategories. Then, initiate a multi-round collaboration process until a final solution is reached. The brain regions will give critical comments and detailed suggestions whenever necessary.
